...
// Custom Type definition for MATLAB Function: '<S77>/StartPointGenerator'
#include <stdio.h>
...
// Custom Type definition for MATLAB Function: '<S77>/WayPointGenerator'
#ifndef struct_uavDubinsConnection_FlightMissionMode_g_T
#define struct_uavDubinsConnection_FlightMissionMode_g_T

struct uavDubinsConnection_FlightMissionMode_g_T
{
    real_T MinTurningRadius;
    real_T AirSpeed;
    real_T MaxRollAngle;
...
#endif                      // struct_uavDubinsConnection_FlightMissionMode_g_T

#ifndef struct_DubinsObjSingleton_FlightMissionMode_m_T
#define struct_DubinsObjSingleton_FlightMissionMode_m_T

struct DubinsObjSingleton_FlightMissionMode_m_T
{
    real_T AirSpeed;
    real_T MaxRollAngle;
    real_T FlightPathAngleLimit[2];
    uavDubinsConnection_FlightMissionMode_g_T Connector;
};

#endif                       // struct_DubinsObjSingleton_FlightMissionMode_m_T
...
#ifndef struct_uavDubinsPathSegment_FlightMissionMode_c_T
#define struct_uavDubinsPathSegment_FlightMissionMode_c_T

struct uavDubinsPathSegment_FlightMissionMode_c_T
{
    real_T StartPose[4];
    real_T GoalPose[4];
    real_T FlightPathAngle;
...
#endif                     // struct_uavDubinsPathSegment_FlightMissionMode_c_T

#ifndef struct_cell_wrap_22_FlightMissionMode_j_T
#define struct_cell_wrap_22_FlightMissionMode_j_T

struct cell_wrap_22_FlightMissionMode_j_T
{
    cell_wrap_11_FlightMissionMode_T f1[4];
};

#endif                             // struct_cell_wrap_22_FlightMissionMode_j_T
...
// Custom Type definition for MATLAB Function: '<S166>/WayPointGenerator'
#include <stdio.h>
