...
#ifndef struct_uav_sluav_internal_system_WaypointFollower_FlightMissionMode_ccd_T
#define struct_uav_sluav_internal_system_WaypointFollower_FlightMissionMode_ccd_T

struct uav_sluav_internal_system_WaypointFollower_FlightMissionMode_ccd_T
{
    int32_T isInitialized;
    cell_wrap_FlightMissionMode_T inputVarSize[3];
    real_T LookaheadDistance;
...
#endif
// struct_uav_sluav_internal_system_WaypointFollower_FlightMissionMode_ccd_T
