...
class codegenReal2MissionModelClass final
{
  ...
  public:
    ...
    struct DW_codegenReal2Mission_T {
        ...
        FILE* eml_openfiles_b[20];     // '<S51>/ReadPursuitShiftPercentage'
        FILE* eml_openfiles_h[20];     // '<S94>/PrintOnboardLog'
        FILE* eml_openfiles_f[20];     // '<S2>/ReadParADRC'
        Msg_IndividualUAVCmd Queue_Msg[16];// '<S82>/Queue'
        FlightLogging Real2SimGuidance_o3;// '<S101>/Real2SimGuidance'
        missionCmd MsgRT_Buf[2];       // '<S46>/MsgRT'
        missionCmd MsgRT_Buf_a[2];     // '<S47>/MsgRT'
        IndividualUAVCmd Receive_o2;   // '<S82>/Receive'
        IndividualUAVCmd Receive;      // '<S91>/Receive'
        IndividualUAVCmd Receive_o2_m; // '<S81>/Receive'
        Buffer_IndividualUAVCmd
            Queue_InsertedFor_MissionValidation_at_inport_0_Queue;// synthesized block 
        IndividualUAVCmd Memory_PreviousInput;// '<S82>/Memory'
        ...
        missionCmd Receive_o2_d;       // '<S46>/Receive'
        missionCmd Receive_o2_p;       // '<S47>/Receive'
        ...
        missionCmd MissionCMD;         // '<S83>/DataStoreMissionCmd'
        ...
        Queue_IndividualUAVCmd Queue_Queue;// '<S82>/Queue'
        ...
        real_T DivideThree;            // '<S51>/DivideThree'
        real_T PursuitShift;           // '<S51>/ReadPursuitShiftPercentage'
        ...
        int32_T DelayInput1_DSTATE;    // '<S86>/Delay Input1'
        int32_T DelayInput1_DSTATE_e;  // '<S43>/Delay Input1'
        ...
        int8_T RateTransition_RdBufIdx;// '<S100>/Rate Transition'
        int8_T RateTransition_WrBufIdx;// '<S100>/Rate Transition'
        ...
        int8_T MsgRT_RdBufIdx;         // '<S46>/MsgRT'
        int8_T MsgRT_WrBufIdx;         // '<S46>/MsgRT'
        int8_T RateTransition_RdBufIdx_c;// '<S46>/Rate Transition'
        int8_T RateTransition_WrBufIdx_j;// '<S46>/Rate Transition'
        int8_T MsgRT_RdBufIdx_b;       // '<S47>/MsgRT'
        int8_T MsgRT_WrBufIdx_b;       // '<S47>/MsgRT'
        int8_T RateTransition_RdBufIdx_o;// '<S47>/Rate Transition'
        int8_T RateTransition_WrBufIdx_h;// '<S47>/Rate Transition'
        ...
        boolean_T RateTransition_Buf_c[2];// '<S46>/Rate Transition'
        boolean_T RateTransition_Buf_l[2];// '<S47>/Rate Transition'
        ...
        boolean_T Memory_PreviousInput_p;// '<S47>/Memory'
        volatile boolean_T RateTransition_Buffer0;// '<S7>/Rate Transition'
        boolean_T followSwitch_start;  // '<S7>/NewMission'
        boolean_T PursuitShift_not_empty;// '<S51>/ReadPursuitShiftPercentage'
...
//  '<S41>'  : 'codegenReal2Mission/MissionLogic/FeedbackCurrentMission/TriggerCurrentMisisonFeedback'
//  '<S42>'  : 'codegenReal2Mission/MissionLogic/FeedbackCurrentMission/TriggerCurrentMisisonFeedback/TimeConverter'
//  '<S43>'  : 'codegenReal2Mission/MissionLogic/FlightMission/Detect Change'
//  '<S44>'  : 'codegenReal2Mission/MissionLogic/FlightMission/JumpDelay'
//  '<S45>'  : 'codegenReal2Mission/MissionLogic/FlightMission/MissionUAVScheduling'
//  '<S46>'  : 'codegenReal2Mission/MissionLogic/FlightMission/MsgRateTransitionA'
//  '<S47>'  : 'codegenReal2Mission/MissionLogic/FlightMission/MsgRateTransitionB'
//  '<S48>'  : 'codegenReal2Mission/MissionLogic/FlightMission/NewMission'
//  '<S49>'  : 'codegenReal2Mission/MissionLogic/FlightMission/TriggerNewMissionBroadcast'
//  '<S50>'  : 'codegenReal2Mission/MissionLogic/FlightMission/getCurrentTime'
//  '<S51>'  : 'codegenReal2Mission/MissionLogic/FlightMission/JumpDelay/ComputDelay'
//  '<S52>'  : 'codegenReal2Mission/MissionLogic/FlightMission/JumpDelay/ComputDelay/ReadPursuitShiftPercentage'
//  '<S53>'  : 'codegenReal2Mission/MissionLogic/FlightMission/getCurrentTime/CurrentTime'
//  '<S54>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/Degrees to Radians'
//  '<S55>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/Degrees to Radians1'
//  '<S56>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/Degrees to Radians2'
//  '<S57>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth'
//  '<S58>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/ReadHomePoint'
//  '<S59>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap'
//  '<S60>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0'
//  '<S61>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem'
//  '<S62>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/pos_rad'
//  '<S63>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap/Latitude Wrap 90'
//  '<S64>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap/Wrap Longitude'
//  '<S65>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap/Latitude Wrap 90/Compare To Constant'
//  '<S66>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap/Latitude Wrap 90/Wrap Angle 180'
//  '<S67>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap/Latitude Wrap 90/Wrap Angle 180/Compare To Constant'
//  '<S68>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap/Wrap Longitude/Compare To Constant'
//  '<S69>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0/Latitude Wrap 90'
//  '<S70>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0/Wrap Longitude'
//  '<S71>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0/Latitude Wrap 90/Compare To Constant'
//  '<S72>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0/Latitude Wrap 90/Wrap Angle 180'
//  '<S73>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0/Latitude Wrap 90/Wrap Angle 180/Compare To Constant'
//  '<S74>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/LatLong wrap LL0/Wrap Longitude/Compare To Constant'
//  '<S75>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem/Angle Conversion2'
//  '<S76>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem/Find Radian//Distance'
//  '<S77>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem/Find Radian//Distance/Angle Conversion2'
//  '<S78>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem/Find Radian//Distance/denom'
//  '<S79>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem/Find Radian//Distance/e'
//  '<S80>'  : 'codegenReal2Mission/MissionLogic/LatLon2NorthEast/LLA to Flat Earth/Subsystem/Find Radian//Distance/e^4'
//  '<S81>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/MissionValidation'
//  '<S82>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/QueueCMD'
//  '<S83>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/MissionValidation/TriggerMissionDispatch'
//  '<S84>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/MissionValidation/TriggerMissionDispatch/CommandCheck'
//  '<S85>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/QueueCMD/Compare To Constant'
//  '<S86>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/QueueCMD/Detect Change'
//  '<S87>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/QueueCMD/IsAvoidDanger'
//  '<S88>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/QueueCMD/MsgConvert'
...
//  '<S97>'  : 'codegenReal2Mission/MissionLogic/PreProcessMissionCMD/QueueCMD/MsgConvert/TimeConverter'
...
//  '<S100>' : 'codegenReal2Mission/MissionLogic/VisualizeUAV/VisualizeUAV'
