//
// File: rt_mrdivide_U1d128x3_U2d3x3_Yd128x3_snf.cpp
//
...
void rt_mrdivide_U1d128x3_U2d3x3_Yd128x3_snf(const real_T u0[384], const real_T
    u1[9], real_T y[384])
{
    real_T A[9];
    real_T a21;
    ...
    for (rtemp = 0; rtemp < 128; rtemp++) {
        int32_T y_tmp;
        int32_T y_tmp_0;
        int32_T y_tmp_1;
        y_tmp = static_cast<int32_T>(static_cast<int32_T>(r1 << 7) + rtemp);
        y[y_tmp] = u0[rtemp] / A[r1];
        y_tmp_0 = static_cast<int32_T>(static_cast<int32_T>(r2 << 7) + rtemp);
        y[y_tmp_0] = u0[static_cast<int32_T>(rtemp + 128)] - A
            [static_cast<int32_T>(r1 + 3)] * y[y_tmp];
        y_tmp_1 = static_cast<int32_T>(static_cast<int32_T>(r3 << 7) + rtemp);
        y[y_tmp_1] = u0[static_cast<int32_T>(rtemp + 256)] - A
